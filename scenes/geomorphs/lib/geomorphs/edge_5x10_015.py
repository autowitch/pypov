...
def edge_5x10_015_info():
    return Metadata("Pit with side room", "e15",
            description="Pit with side room",
            block_type="edge",
            bottom=-50, top=20,
            size="5x10",
            repeatable=True,
...
def edge_5x10_015(rotate=(0, 0, 0), translate=(0, 0, 0), detail_level=1,
    ...
    geomorph = Union(
        Difference(
            ...
            Union(
                ...
                Box(( -27.50001, 10,      -20.0), (27.50001, 21,  -15.0)),

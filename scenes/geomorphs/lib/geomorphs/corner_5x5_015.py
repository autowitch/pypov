...
def corner_5x5_015_info():
    return Metadata("Basic diamond shaped room with round side rooms", "c15",
...
def corner_5x5_015(rotate=(0, 0, 0), translate=(0, 0, 0), detail_level=1,

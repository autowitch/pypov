...
def edge_5x10_014_info():
    return Metadata("Pit with crossing bridges", "e14",
            description="Deep with with bridges crossing both it and each other",
            block_type="edge",
            bottom=-50, top=20,
            size="5x10",
            repeatable=False,
            ...
            wet=False,
            multi_level=False,
            keywords=['pit', 'bridges', 'bridge', 'arch', 'crossing'])

...
def corner_5x5_012_info():
    return Metadata("Basic round room", "c12",
            description="Basic circular room",
            block_type="corner",
            bottom=0, top=20,
            size="5x5",
            repeatable=True,
            ...
            wet=False,
            multi_level=False,
            keywords=['round', 'circular', 'rooms', 'basic'])

def corner_5x5_012(rotate=(0, 0, 0), translate=(0, 0, 0), detail_level=1,
    ...
    geomorph = Union(
        Difference(
            ...
            Cylinder((0, 10.0001, 0), (0, 21, 0), 14),
            wall_texture_1
        ),
        translate=translate,
        rotate=rotate
